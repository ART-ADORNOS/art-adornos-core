                    ...
                    <div className="p-8 flex flex-col justify-center">
                        ...
                        <div className="mt-6 grid grid-cols-1 md:grid-cols-3 gap-6 text-center">
                            ...
                            <div className="flex flex-col items-center">
                                ...
                                <span className="mt-2 text-gray-700 dark:text-gray-300 font-semibold text-lg">Categoría</span>
                                <p className="text-gray-500 dark:text-gray-400 text-sm">{product.category}</p>
                            </div>

                            <div className="flex flex-col items-center">
                                <FaDollarSign className="text-green-500 text-3xl"/>
                                <span className="mt-2 text-gray-700 dark:text-gray-300 font-semibold text-lg">Precio</span>
                                <p className="text-gray-500 dark:text-gray-400 text-sm">${product.price}</p>
                            </div>

                            <div className="flex flex-col items-center">
                                <FaBoxOpen className="text-yellow-500 text-3xl"/>
                                <span className="mt-2 text-gray-700 dark:text-gray-300 font-semibold text-lg">Stock</span>
